      ...
      <div>
        ...
        <div className="flex flex-col gap-[40px] py-[40px] laptop:py-[2.3rem] px-4 tablet:px-8 laptop:px-[126px] mb-[5rem]">
          ...
          <div className="flex flex-wrap justify-center gap-4 tablet:justify-between items-center">
            ...
            <div className="w-[120px] tablet:w-[154px] py-3 flex justify-center bg-[#E2E2E2]">
              <Image
                src="/umurava.png"
                alt="Umurava"
                width={178.15}
            ...
            <div className="w-[120px] tablet:w-[154px] py-4 flex justify-center bg-[rgb(226,226,221)]">
              <Image
                src="/klab.png"
                alt="Programs"
                width={113.82}
            ...
            <div className="w-[120px] tablet:w-[154px] py-1 bg-[rgb(226,226,224)]">
              <Image
                src="/iremboreal.png"
                alt="Programs"
                width={163.3}
